...
//     return (
//         <section className="flex flex-1 bg-orange-100 mb-10  flex-col md:flex-row h-full md:justify-center  md:space-y-5">
//             <div className="ml-10 mt-32 space-y-6 md:justify-center">
//                 <h1 className="font-extrabold text-4xl">50+ Beautiful rooms <br />
//                     inspiration</h1>
//                 <p>Our designer already made a lot of <br /> beautiful prototipe of rooms that inspire you</p>

//                 <div className="flex items-center  mt-6 mb-20">
//                     <button className="relative px-20 overflow-hidden border-2 border-orange-700 text-white inline-block text-[15px] leading-[15px] py-[18px]  no-underline cursor-pointer bg-orange-600 select-none hover:text-orange-700">
...
//             <div className=" flex items-center ml-6 mt-6 md:ml-12">
