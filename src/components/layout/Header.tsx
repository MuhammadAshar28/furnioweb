...
const Header = () => {
  ...
  return (
    ...
    <header className="flex  space-x-8 space-y-8 w-full mb-50 fixed top-0 z-50  justify-between  bg-background/95 border-b backdrop-blur supports-[backdrop-filter]:bg-background/60 mb-7 sm:mb-12 md:mb-16 xs:mb-12">
